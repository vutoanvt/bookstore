...
<div id="wrapper">
		...
		<div id="content_center">
			<div class="cc_news">
				...
				<img src="images/lichsu.jpg">
					<a href="page.php">Thu Pháp VietNam</a> <br/>
						Tác gi?: Nguy?n S? <br/>
						D?ch gi?: <br/>
	...
	<aside class="middle-sidebar">
			...
			<form class="quote">
				...
				<br>
				<button class="button_1" type="submit">Ðang Nh?p</button>
			</form>-->
			<div class="row">
				<div class="col-md-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<div id="errors">
								...
								<button type="submit" class="btn btn-primary">Ðang nh?p</button>
							</form>
						</div>
					</div>
				</div>
